...
5.  When the .NET application takes a call, it launches an instance of the [Browser](/dotnet/api/microsoft.rtc.collaboration.audiovideo.voicexml.browser?view=ucma-voice). The application launches a separate **Browser** instance for each call that it answers.
