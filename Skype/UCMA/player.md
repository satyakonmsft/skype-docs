...
description: An overview of the Player (Unified Communications Managed API 5.0) class.
TOCTitle: Player
...
The following code example shows the steps involved in using a [Player](/dotnet/api/microsoft.rtc.collaboration.audiovideo.player?view=ucma-api&preserve-view=true).
