...
description: The Planning performance counters can be used for performance analysis, modeling, and capacity planning.
...
**Number of failed end-to-end connectivity checks**
