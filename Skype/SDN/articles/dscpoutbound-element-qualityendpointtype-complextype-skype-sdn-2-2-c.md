...
description: Describes the Schema C iteration of the DSCPOutbound element and provides the element's definition, parent elements, and element information.
