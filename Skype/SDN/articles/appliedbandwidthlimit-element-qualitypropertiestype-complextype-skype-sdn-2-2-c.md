...
description: Describes the Schema C iteration of the AppliedBandwidthLimit element and provides the element's definition, element information, and parent elements.
