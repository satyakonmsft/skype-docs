...
description: Describes the Schema D iteration of the Properties element (QualityType complexType) and provides the definition, parent elements, and information.
...
# Properties element (QualityType complexType) (Schema D)
