...
description: Describes the Schema D iteration of the DSCPOutbound element and provides the element's definition, parent elements, and element information.
