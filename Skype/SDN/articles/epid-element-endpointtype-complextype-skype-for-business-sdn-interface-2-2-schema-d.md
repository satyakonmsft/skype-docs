...
description: Describes the Schema D iteration of the EPId element (EndPointType complexType) and provides the element's definition and parent elements.
