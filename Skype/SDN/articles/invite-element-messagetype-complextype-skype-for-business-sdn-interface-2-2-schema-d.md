...
description: Describes the Schema D iteration of the Invite element (MessageType complexType) and provides the element's type, definition, and parent/child elements.
