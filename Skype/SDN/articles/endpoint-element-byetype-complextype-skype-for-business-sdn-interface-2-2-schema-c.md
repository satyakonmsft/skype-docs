...
description: Describes the Schema C iteration of the EndPoint element (ByeType complexType) and provides the element's definition and element information.
