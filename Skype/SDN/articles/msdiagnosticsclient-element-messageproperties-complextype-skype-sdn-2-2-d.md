...
description: Describes the Schema D iteration of the MSDiagnosticsClient element (MessageProperties complexType) and provides the element's definition and parent elements.
